...
All the controller methods return one of Spring HATEOAS’s 
RepresentationModel subclasses to properly render hypermedia (or a wrapper around such a type).
*/
...
class OrderController {
  ...
  //in case the oder/operation is cancelled
  /*
  ...
  */ 
  ...
  /*
   This implements similar logic to prevent an Order status from being completed unless 
   in the proper state. 
